...
export declare function merge<P = any, T = any>(defaultOptions: P, options: T, strict?: boolean): P & T;
...
export declare function safeJSONParse(value: string, returnValueOnError?: boolean): any;
export declare function createEmptyScheme<T>(keys: string[], value?: any): T;
export declare function mutate<T>(value: T, mutator: (value: T) => void): T;
export {};
